...
public class ACCommandRoot extends SCommandRoot<Autocraft> {
	...
	public CmdSpeed CMD_SPEED = new CmdSpeed();
	public CmdScourgeTorpedo CMD_SCOURGE_TORPEDO = new CmdScourgeTorpedo();
	public CmdWarp CMD_WARP = new CmdWarp();
	...
	public ACCommandRoot(Autocraft s) {
		...
		addCommand(CMD_SPEED);
		addCommand(CMD_SCOURGE_TORPEDO);
		addCommand(CMD_WARP);
	}
